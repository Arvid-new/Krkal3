...
namespace Puzzle.Windows.Forms.SyntaxBox.Painter
{
	...
	public class Painter_GDI : IPainter
	{
		...
		public void InitGraphics()
		{
			...
			if (Control != null)
			{
				if (Control.IsHandleCreated)
				{
					...
					ViewPoint view = Control.View;
					view.RowHeight = GFX.BackBuffer.MeasureTabbedString("ABC", 0)
						.Height + this.Control._SyntaxBox.RowPadding;
					view.CharWidth = GFX.BackBuffer.MeasureTabbedString(" ", 0)
						.Width;
					Control.View = view;
		...
		public void RenderAll()
		{
			//
			ViewPoint view = Control.View;
			view.RowHeight = GFX.BackBuffer.MeasureString("ABC").Height;
			view.CharWidth = GFX.BackBuffer.MeasureString(" ").Width;
			Control.View = view;
